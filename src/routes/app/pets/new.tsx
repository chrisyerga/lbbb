...
function NewPetPage() {
  ...
  return (
    <PageShell eyebrow="New Pet" title="Create the pet profile before generating content.">
      <form onSubmit={(e) => void onSubmit(e)} className="panel max-w-lg grid gap-4 p-6 text-sm">
        ...
        <label className="grid gap-2 text-[var(--text-primary)]">
          Breed (optional)
          <input value={breed} onChange={(e) => setBreed(e.target.value)} className="input-field" placeholder="Corgi" />
        </label>
