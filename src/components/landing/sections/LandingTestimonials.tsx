  ...
  return (
    <section className="relative px-4 py-16 sm:px-8 sm:py-24 lg:px-14 lg:py-[120px]">
      <div className="mb-12 text-center sm:mb-14">
        <Pill bg="var(--landing-soft)" color="var(--landing-ink)" className="mb-4">
          Pet parents say
        </Pill>
        ...
        {TESTIMONIALS.map((q) => (
          ...
          >
            ...
            <div className="mt-[22px] flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-bold text-[var(--landing-ink)]">{q.name}</div>
                <div className="text-xs text-[var(--landing-ink)]/65">{q.loc}</div>
              </div>
            </div>
          </div>
        ))}
